...
class _StoreDetailScreenState extends State<StoreDetailScreen> {
  ...
  void initTheme() {
    if (widget.market.theme != null) {
      ...
      //font second color
      if (widget.market.theme!.secondaryFontColor != null) {
        bloc.add(
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              // آیکون‌های اطلاع‌رسانی صفحه فروشگاه طبق PDF:
                              // ۱.گزارش ۲.اشتراک‌گذاری ۳.نشان‌گذاری ۴.آمار مشاهده ۵.نظرات ۶.علاقه‌مندی ۷.راهنما
                              mainAxisAlignment: MainAxisAlignment.spaceAround,
                              children: [
                                // ۱. گزارش: گزارش محتوای نامناسب
                                InkWell(
                                  onTap: () {},
                                  child: Icon(
                                ...
                                // ۲. اشتراک‌گذاری: ارسال لینک فروشگاه
                                InkWell(
                                  onTap: () {
                                    ShareStore.share(
...
/*
class StoreScrollableButtonList extends StatefulWidget {
  @override
  _StoreScrollableButtonListState createState() => _StoreScrollableButtonListState();
}

class _StoreScrollableButtonListState extends State<StoreScrollableButtonList> {
