...
class CreateWorkSpaceBloc
  ...
  CreateWorkSpaceBloc(this.marketRepo, this.regionRepo)
    ...
    on<CreateMarket>((event, emit) async {
      try {
        ...
        if (res is Success) {
          final initList = Map<String, dynamic>.from(res.response as Map);
    ...
    on<ChangeHasWorkTime>((event, emit) {
      ...
      // ignore: avoid_print
      debugPrint(state.hasWorkTime.toString());
    });
  ...
  _getCountries(LoadCountry event, Emitter<CreateWorkSpaceState> emit) async {
    ...
    try {
      ...
      if (res is Success) {
        ...
        final countryList = resp.map((e) => CountryModel.fromJson(Map<String, dynamic>.from(e))).toList();
  ...
  _getProvinces(LoadProvince event, Emitter<CreateWorkSpaceState> emit) async {
    ...
    try {
      ...
      if (res is Success) {
        var resp = res.response as List;
        final provinceList = resp.map((e) => CountryModel.fromJson(Map<String, dynamic>.from(e))).toList();
  ...
  _getCities(LoadCity event, Emitter<CreateWorkSpaceState> emit) async {
    ...
    try {
      ...
      if (res is Success) {
        var resp = res.response as List;
        final cityList = resp.map((e) => CountryModel.fromJson(Map<String, dynamic>.from(e))).toList();
