...
class VendorBloc extends Bloc<VendorEvent, VendorState> {
  ...
  _getSlider(LoadSlider event, Emitter<VendorState> emit) async {
    ...
    try {
      ...
      if (res is Success) {
        ...
        final sliderList = resp.map((e) => SliderModel.fromJson(Map<String, dynamic>.from(e))).toList();
  ...
  _getComments(LoadComments event, Emitter<VendorState> emit) async {
    ...
    try {
      ...
      if (res is Success) {
        var resp = res.response as List;
        final commentList = resp.map((e) => CommentModel.fromJson(Map<String, dynamic>.from(e))).toList();
        emit(
          state.copyWith(
