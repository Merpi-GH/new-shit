...
class PublishMarket extends WorkspaceEvent {
  final String marketId;
  const PublishMarket({required this.marketId});
}

class UnPublishMarket extends WorkspaceEvent {
  final String marketId;
  const UnPublishMarket({required this.marketId});
}

class DeactivateMarket extends WorkspaceEvent {
  final String marketId;
  const DeactivateMarket({required this.marketId});
}
